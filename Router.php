...
class Router
{
    ...
    public function comprobarRutas()
    {
        ...
        //SI EL METODO ES GET
        if ($method === 'GET') {
            //Leemos el valor de cada llave en el arrego getRoutes
            $fn = $this->getRoutes[$currentUrl] ?? null;//fn será la funcion de esta RUTA GET
        } else {
            //Leemos el valor de cada llave en el arrego postRoutes
        ...
        if ( $fn ) {
            ...
            call_user_func($fn, $this); // This es para pasar argumentos, ya que en this se encuentran los arreglos postRoutes y getRoutes
        } else {
